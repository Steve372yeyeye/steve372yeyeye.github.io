...
echo loading menu
sleep 1
opt=$(whiptail --clear --title "主菜单" --menu "请选择你要执行的功能" 15 45 7  "0" "Android-Termux工具(正在开发)" "1" "安装$ARCH_qp容器"  "2" "返回到旧版本页面" "3" "安装恢复包" "4" "导出系统" "5" "安装x64架构的容器(推荐arm64)" "6" "安装X86架构的容器(推荐arm64)" "7" "检查更新" "8" "下载脚本到本地" "10" "退出"  3>&1 1>&2 2>&3)
exitstatus=$?
